...
import { TabState, AssistantType } from '../types'; 
...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  const assistantLabel = activeAssistant === 'lexi' ? "Switch to KebapGPT" : "Switch to Lexi";
